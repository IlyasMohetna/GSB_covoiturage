@extends('layout.app')
@section('content')
@inject('calculateTimeDifference', 'App\Services\TimeService')
@php
use Carbon\Carbon;
@endphp
						...
						<table class="table whitespace-nowrap min-w-full">
							...
							<tbody>
								...
								<tr class="border-b border-defaultborder">
                                    ...
                                    <td class="text-center">{{ $calculateTimeDifference->for($reservation->etape_depart->date_passage,$reservation->etape_arrive->date_passage) }}</td>
