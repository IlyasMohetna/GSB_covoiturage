...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('vehicule', function (Blueprint $table) {
            ...
            $table->string('photo');
            $table->foreignId('id_agence')->index()->nullable()->foreign()->references('id_agence')->on('agence');
            $table->foreignId('code_employe')->index()->nullable()->foreign()->references('code_employe')->on('employe');
            $table->timestamps();
        });
    }
